    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top border-bottom">
        <div class="container">
            <a class="navbar-brand" href="index.php">
                <img src="img/logo.svg" alt="ADUFMS" class="img-fluid" width=180>
            </a>
            ...
            <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarNav">
                <ul class="navbar-nav align-items-center ms-auto">
                    ...
                    <li class="nav-item font-17 me-0 me-lg-3">
                        <a class="nav-link color-black" href="convenios.php">Convênios</a>
                    </li>
                    <li class="nav-item font-17 me-0 me-lg-3">
                        <a class="nav-link color-black" href="noticias.php">Notícias</a>
                    </li>
                    <li class="nav-item font-17 me-0 me-lg-3">
                        <a class="nav-link color-black" href="artigos.php">Artigos</a>
                    </li>
                    <li class="nav-item font-17 me-0 me-lg-3">
                        <a class="nav-link color-black" href="agenda.php">Agenda</a>
                    </li>
                    <li class="nav-item font-17 me-0 me-lg-3">
                        <a class="nav-link color-black" href="galeria.php">Galeria de Vídeos</a>
                    </li>
                    <li class="nav-item font-17 me-0 me-lg-3">
